...
<div align="center">
  ...
  <h1>togo-framework/widget-contact</h1>
  <p>
    <a href="https://to-go.dev/marketplace"><img src="https://img.shields.io/badge/marketplace-to--go.dev-1F8A99" alt="marketplace" /></a>
    <a href="https://pkg.go.dev/github.com/togo-framework/widget-contact"><img src="https://pkg.go.dev/badge/github.com/togo-framework/widget-contact.svg" alt="pkg.go.dev" /></a>
...
```bash
togo install togo-framework/widget-contact
```
...
This widget's **UI** lives in [`web/index.tsx`](web/index.tsx) - the React component the board renders. It imports `@togo-framework/widget`, is settings-backed, and registers itself. The Go module embeds `web/` via `go:embed`.
